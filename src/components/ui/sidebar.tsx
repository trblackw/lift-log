...
function SidebarInput({
  className,
  ...props
}: React.ComponentProps<typeof StandardInput>) {
  return (
    <StandardInput
...
function SidebarContent({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'flex min-h-0 flex-1 flex-col gap-2 overflow-auto scroll-container group-data-[collapsible=icon]:overflow-hidden',
        className
      )}
      {...props}
    />
